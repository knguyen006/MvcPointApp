...
namespace DataLayerService
{
    public class ProfileSvcImpl: IProfileSvc
    {
        ...
        public void editProfile(profile pro)
        {
            ...
            dbList.familyname = pro.familyname;
        ...
        public void addProfile(profile pro, member mem)
        {
            db.profiles.Add(pro);
            db.SaveChanges();
        }

        public List<profile> GetAll(member mem)
        {
            return db.profiles.Where(p => p.memberid == mem.memberid).ToList();
        }
    }
}
