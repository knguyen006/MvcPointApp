...
namespace PointSiteTest
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        private void ExecuteInsert(string username, string userpass, string passphrase, string membertype)
        {
            SqlConnection conn = new SqlConnection(GetConnectionString());
            string sql = "INSERT INTO member (username, userpass, passphrase, membertype, approleid) VALUES "
                + "(@username, @userpass, @passphrase, @membertype, 2)";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (userpass.Text == reuserpass.Text)
            {
